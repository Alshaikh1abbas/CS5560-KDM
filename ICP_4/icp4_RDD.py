...
df = sqlContext.read.csv(SparkFiles.get("B:/InTo/ICP_4/data.csv"), header=True, inferSchema= True)
df.printSchema()
#df.show(5, truncate = False)

#If you didn't set inderShema to True, here is what is happening to the type. There are all in string.
#df_string = sqlContext.read.csv(SparkFiles.get("B:/InTo/ICP_4/data.csv"), header=True, inferSchema=  False)
